...
public class Tamagochi extends JFrame  implements LeeRed {
	...
	private String nombres[]={"feliz.png","enamorado.jpeg","ansioso.png","triste.png","sueno.png"};
	private int turno;
	...
	public Tamagochi(){
	   ...
	   enfermo=new JButton("enamorado");
	   enfermo.addActionListener(eh);  
	   triste=new JButton("ansioso");
	   triste.addActionListener(eh);  
	   enojado=new JButton("triste");
	   enojado.addActionListener(eh);  
	   dormido=new JButton("sueno");
